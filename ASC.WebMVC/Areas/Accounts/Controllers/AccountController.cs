...
using ASC.Utilities;
using ASC.WebMVC.Areas.Accounts.Models;
using System.Threading.Tasks;
using System.Linq;

namespace ASC.WebMVC.Areas.Accounts.Controllers
{
    [Area("Accounts")]
    [Authorize]
    public class AccountController : Controller
    {
        ...
        {
            var serviceEngineers = await _userManager.GetUsersInRoleAsync("Enginer");
        ...
        {
            var users = await _userManager.GetUsersInRoleAsync("Enginer");
